...
public final class LotteryDrawing implements LotteryDrawingIF {
	...
	protected int num_lotto_balls;  // number of balls used in each drawing
	protected int max_ball_number;  // max ball number
	protected int simulation_drawings;  // number of drawings in simulation @ 2/week
	protected int[] results;  		// keeps track of simulation results
	protected Random rand;  		  // random number source
	 ...
	 */
	protected int intersection(int[] a, int[] b) {
	 ...
	 * @return
	 */
	protected boolean already_have(int[] a, int n) {
		for (int next_a : a) {
	 ...
	 */
	protected Set<Integer> pick_numbers_using_Set() {
