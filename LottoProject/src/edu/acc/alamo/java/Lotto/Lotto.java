 ...
 *
 * Define a new class called Lotto and a protected method called calc_odds() that returns the odds of winning. Use the following algorithm to exercise your array skills:
 ...
 *        keeps track of the number of matches in a protected LotteryDrawing array called results[]. Array length should cover all the match possibilites. Results[] should be available using a getter
 *
...
public final class Lotto implements LottoIF {
	...
	protected int num_lotto_balls = NUM_LOTTO_BALLS;  // default number of balls
	protected int max_ball_num = MAX_BALL_NUM;  // default max ball number
	protected int simulation_years = SIMULATION_YEARS; // default years to run simulation
